...
public class DBManager {
    ...
    public void copyDBFile() {
        ...
        if (!dbFile.exists()) {
            ...
            OutputStream os;
            try {
                is = mContext.getResources().openRawResource(R.raw.city);
    ...
    public List<City> getAllCities() {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM " + TABLE_NAME + " WHERE LEVEL = '2' AND pinyin != ''", null);
    ...
    public List<City> searchCity(final String keyword) {
        SQLiteDatabase db = SQLiteDatabase.openOrCreateDatabase(DB_PATH + DB_NAME, null);
        Cursor cursor = db.rawQuery("SELECT * FROM " + TABLE_NAME + " WHERE LEVEL = '2' AND pinyin != '' AND (name LIKE \"%" + keyword
